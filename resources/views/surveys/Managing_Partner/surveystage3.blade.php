    ...
    <div class="row justify-content-center">
        ...
        <div class="col-7 border border-black">
            <div class="progress">
                ...
                <div class="progress-bar bg-primary" role="progressbar" style="width: 33.33%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">
                    <span class="fs-6">Integrity/ Trust</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-7 border border-dark">
            <div class="h6">
                <p>
                    <ol>
                        <li>
                            Do you trust the current Managing Partner? Do you think they have integrity in their work?<br>
                            It's okay to say No btw
                        </li>
                    </ol>
                </p>
                ...
                <form class="form-group" action="{{ route('mp.survey.p3.post', ['user_id' => auth()->user()->id]) }}" method="POST">
                    @csrf
                    <div class="">
                        <div class="mb-2">
                            <input type="radio" name="mp_trust_rating" id="exceptional" value="5">
                            <label class="btn btn-primary" for="exceptional">5 - Exceptional</label>
                        </div>
                        <div class="mb-2">
                            <input type="radio" name="mp_trust_rating" id="exceeds" value="4">
                            <label class="btn btn-primary" for="exceeds">4 - Exceeds Expectations</label>
                        </div>
                        <div class="mb-2">
                            <input type="radio" name="mp_trust_rating" id="meets" value="3">
                            <label class="btn btn-primary" for="meets">3 - Meets Expectations</label>
                        </div>
                        <div class="mb-2">
                            <input type="radio" name="mp_trust_rating" id="below" value="2">
                            <label class="btn btn-primary" for="below">2 - Below Expectations</label>
                        </div>
                        <div class="">
                            <input type="radio" name="mp_trust_rating" id="improve" value="1">
