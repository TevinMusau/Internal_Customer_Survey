            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse" class="accordion-collapse collapse" aria-labelledby="heading" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <p>Write a comment for the Managing Partner:</p>
                            
                            <div class="">
                                <div class="mb-2">
                                    <div class="mb-3">
                                        <label for="managing_partner_comment" class="form-label">Comment Area</label>
                                        <textarea class="form-control" id="managing_partner_comment" rows="3" name="managing_partner_comment"></textarea>
                                    </div>
                                </div>
                            </div>
                            <hr>
