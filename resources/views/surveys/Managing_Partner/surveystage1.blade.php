    ...
    <div class="row justify-content-center">
        ...
        <div class="col-7">
            <div class="progress">
                ...
                <div class="progress-bar progress-bar-striped progress-bar-animated bg-dark" role="progressbar" style="width: 70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
        </div>
        ...
        <div class="col-7">
            <div class="h6">
                <p>
                    <ol>
                        <li>
                            How would you rate the current Managing Partner in terms of their punctuality?
                        </li>
                    </ol>
                </p>
                ...
                <form class="form-group" action="{{ route('mp.survey.p1.post', ['user_id' => auth()->user()->id]) }}" method="POST">
                    @csrf
                    <div class="">
                        <div class="mb-2">
